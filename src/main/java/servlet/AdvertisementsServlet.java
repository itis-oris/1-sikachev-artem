...
public class AdvertisementsServlet extends HttpServlet {
    ...
    final static Logger logger = LogManager.getLogger(AdvertisementsServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.getRequestDispatcher("/WEB-INF/view/advertisements/advertisementsList.jsp").forward(request, response);
        } catch (DbException e){
            logger.info(e);
